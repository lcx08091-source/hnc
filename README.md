...
![version](https://img.shields.io/badge/version-v3.5.0--rc-purple.svg)
...
```sh
adb push HNC_v3.5.0-rc.zip /sdcard/
adb shell
su
ksud module install /sdcard/HNC_v3.5.0-rc.zip
reboot
```
...
A: v3.5.0-rc 之前的 bug。升级 v3.5.0-rc 或更新版本(R-1 加了 1s de-bounce)。

**Q: 改设备名后 WebUI 没立即更新**
A: v3.5.0-rc 之前 hotspotd 对 manual 设备不会 re-resolve。升级 v3.5.0-rc 或更新版本(R-2 加了 60s 时间窗口,改名后最多 60s 生效)。
